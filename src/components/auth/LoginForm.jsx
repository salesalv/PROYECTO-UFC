...
const LoginForm = () => {
  return (
    <Card className="w-full max-w-md bg-black/80 border-gray-800 text-white">
      <CardHeader>
        <CardTitle className="text-2xl text-red-600">Iniciar Sesión</CardTitle>
        <CardDescription className="text-gray-400">Ingresa tus credenciales para acceder a tu cuenta.</CardDescription>
      </CardHeader>
