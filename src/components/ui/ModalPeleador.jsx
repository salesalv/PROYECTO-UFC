  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <img src={peleador.foto} alt={peleador.nombre} className="w-24 h-24 rounded-full object-cover border-4 border-red-500 mb-2" />
        ...
        <p className="mt-2 text-sm text-gray-300 italic text-center">{peleador.datoExtra}</p>
      </div>
    </div>
  );
};
