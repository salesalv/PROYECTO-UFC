  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p className="mb-1 text-center"><b>{t('fighter.division')}</b> {peleador.division}</p>
        <p className="mb-1 text-center"><b>{t('fighter.country')}</b> {peleador.pais}</p>
        <p className="mb-1 text-center"><b>{t('fighter.record')}</b> {peleador.record}</p>
        <p className="mb-1 text-center"><b>{t('fighter.status')}</b> {peleador.status}</p>
